...
preset_computer = ['A5','B5','C5','D5','E5','G6','G7','G8','G9','E2','F2','G2', 'I4','I5','C9','C10','I9','J1']
...
for i in range(1,19):
   ...
   if preset_computer[i] in game_boardcomputer:
       print(preset_computer[i])
       game_boardcomputer.remove(preset_computer[i])      
...
for i in range(1,1000):
    player_move = input("Players turn! Please select a Letter from (Capital letter Please) A-J and a number 1-10 to make your attack. If you want to see the moves you have already called input Z11")
    moves_called.append(player_move)
    if player_move == 'Z11':
        print(moves_called)
    if player_move in preset_computer:
        print("HIT!!")
        preset_computer.remove(player_move)
    print(preset_computer)    
    ...
    if preset_player1 == [] or preset_computer == []:
        print("Game is over")
        break